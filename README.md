...
- Options page remembers an explicitly selected paper folder and can rebuild the local duplicate index without selecting it again.
...
6. Click `Choose folder` once and select the existing paper folder.
